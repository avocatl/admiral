...
func (m *MockDisplayer) Display(arg0 Displayable) error {
	m.ctrl.T.Helper()
...
func (mr *MockDisplayerMockRecorder) Display(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Display", reflect.TypeOf((*MockDisplayer)(nil).Display), arg0)
}

// DisplayMany mocks base method
func (m *MockDisplayer) DisplayMany(arg0 []Displayable) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DisplayMany", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// DisplayMany indicates an expected call of DisplayMany
func (mr *MockDisplayerMockRecorder) DisplayMany(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DisplayMany", reflect.TypeOf((*MockDisplayer)(nil).DisplayMany), arg0)
}
